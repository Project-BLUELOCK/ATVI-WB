...
export default class CadastroCliente extends Cadastro {
    ...
    public cadastrar(): Cliente {
        ...
        //CPF
        let valor = this.entrada.receberTexto(`Por favor informe o número do CPF, no formato xxx.xxx.xxx-xx: `);
        let data = this.entrada.receberTexto(`Por favor informe a data de emissão do CPF, no formato dd/mm/yyyy: `);
        ...
        //RG
        valor = this.entrada.receberTexto(`Por favor informe o número do RG, no formato xx.xxx.xxx-x: `);
        data = this.entrada.receberTexto(`Por favor informe a data de emissão do RG, no formato dd/mm/yyyy: `);
        ...
        // Telefone
        let tell = this.entrada.receberTexto(`Por favor digite o numero do telefone no formato xx xxxxxxxxx, ou seja ddd+numero:`);
        ...
        for (let index = 0; index < sliceProdutos.length; index++) {
            ...
            if (nomes.includes(sliceProdutos[index])) {
                ...
                let preco = this.entrada.receberNumero(`Defina o preço para os produtos consumidos: "${sliceProdutos[index]}" R$:`)
        ...
        for (let index = 0; index < sliceServico.length; index++) {
            ...
            if (nomes.includes(sliceServico[index])) {
                ...
                let preco = this.entrada.receberNumero(`Defina o preço para o serviços consumidos: "${sliceServico[index]}" R$: `)
